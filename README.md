...
### 👨‍💻 Sobre mim
Com uma base sólida em **Arquitetura de Software**, **Lógica de Programação** e **Cibersegurança**. Atualmente focado em construir soluções eficientes, seguras e orientadas por dados, aplicando a cultura **DevSecOps**.

* 📊 **Dados:** Especialista em Power BI, SQL e análise preditiva.
...
| **Segurança/DevOps** | `DevSecOps`, `Cybersecurity`, `Git` |
| **Dados & IA** | `Power BI`, `Google Gemini`, `Prompt Engineering` |
| **Infra/Arquitetura** | `Banco de Dados`, `Estrutura de Dados` |
